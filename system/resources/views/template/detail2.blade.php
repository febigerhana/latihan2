								...
								<div id="tab2" class="tab-pane fade in active">
									<div class="products-slick" data-nav="#slick-nav-2">
										...
										<div class="product">
											...
											<div class="product-body">
												<p class="product-category">Detail</p>
												<h3 class="product-name"><a href="#">product sniker win</a></h3>
												<h3 class="product-name"><a href="#">Stok 500</a></h3>
												<h3 class="product-name"><a href="#">color blue white red</a></h3>
												<h3 class="product-name"><a href="#">size 37 38 39 40</a></h3>
